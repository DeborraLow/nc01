...
// 	var timeJakarta = document.querySelector('.js-time-jakarta');
// 	var timeBrussels = document.querySelector('.js-time-brussels');

// 	var temperatureJakarta = document.querySelector('.js-temperature-jakarta');
// 	var temperatureBrussels = document.querySelector('.js-temperature-brussels');
